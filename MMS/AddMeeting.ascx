<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AddMeeting.ascx.vb" Inherits="MMS.AddMeeting" %>
...
<table class="view-tbl">
    ...
    <tr>
        <td></td>
        <td class="add-td-2"><asp:Button ID="AddMeeting" runat="server" Text="افزودن" /></td>
    </tr>
</table>